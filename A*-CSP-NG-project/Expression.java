	...
	public class Expression {
	    ...
	    public Expression setVariables(ArrayList<String> names, ArrayList<Integer> testValues) {
    		for(int i = 0; i < names.size() && i < testValues.size(); i++){
    			this.checkVariableName(names.get(i));
	        	this.variables.put(names.get(i), (double) testValues.get(i));
    		}
	        return this;
	    }
